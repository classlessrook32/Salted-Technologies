...
public class ModelClasslessrook32Salty extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
    	...
    	this.leftleg.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 0.922222F * limbSwingAmount;
  
    	this.Rightleg.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float)Math.PI) * 0.922222F * limbSwingAmount;
