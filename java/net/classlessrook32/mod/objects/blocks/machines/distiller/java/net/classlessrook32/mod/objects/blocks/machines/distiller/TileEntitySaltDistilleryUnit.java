...
public class TileEntitySaltDistilleryUnit extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.salt_distillery_unit";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BLOCK_SALT_DISTILLERY_UNIT.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = SaltDistilleryUnitRecipes.getInstance().getDistilleryResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = SaltDistilleryUnitRecipes.getInstance().getDistilleryResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	{
		return "st:salt_distillery_unit";
	}
